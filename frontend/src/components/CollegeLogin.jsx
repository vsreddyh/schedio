      ...
      <div className="content18" id="bodyy8">
        <div id="body-content8">
          ...
          <form onSubmit={handle} method="post">
            <div className="uiux">
            <div className="clkj">
            <input name="serverCollegeName" className="collegename" type="text" id="collegeInput8" placeholder="Organization Name" value={term} onChange={handleInputChange} minLength="3" required />
            </div>
            <br />
            <div id="suggestions8">
        ...
        <div className="sighnup8">
          ...
          <p>Can't find your organization name here? <Link to="/Ins">Click here</Link></p>
        </div>
