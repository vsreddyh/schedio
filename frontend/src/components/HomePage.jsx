        ...
        <div className='total'>
            ...
            <div className='homeelements'>
                <div className='basicgrid'>
                    <div
                        className='bgridelements'
                        onClick={() => handleDomainClick('Healthcare')}
                    >
                    ...
                    <div
                        className='bgridelements'
                        onClick={() => handleDomainClick('Web development')}
                    >
                        <div className='forpic'>
                            <img
                                src='https://sklc-tinymce-2021.s3.amazonaws.com/comp/2023/04/full-stack%20web%20development_1681290664.png'
                                alt='none'
                            />
                        </div>
                        <div className='forname'>
                    ...
                    <div
                        className='bgridelements'
                        onClick={() =>
                            handleDomainClick('Software development')
                        }
                    >
                        <div className='forpic'>
                            <img
                    ...
                    >
                        <div className='forpic'>
                            <img
                                src='https://product.hstatic.net/200000388585/product/khoa-ecommerce-leader_499927079ba847f1b0e4f8ec44fa3d90_1024x1024.jpg'
                                alt='none'
                            />
                        </div>
                        <div className='forname'>
                    ...
                    <div
                        className='bgridelements'
                        onClick={() => handleDomainClick('Cyber Security')}
                    >
                        <div className='forpic'>
                            <img
                                src='https://www.ctemag.com/sites/default/files/page_images/blockchain-tech-manufacturing.jpg'
                                alt=''
                            />
                        </div>
                        <div className='forname'>
